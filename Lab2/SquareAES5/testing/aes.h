...
void aesEncryptVector(vector<byte> &cipher, vector<byte> &message, byte* expanded_key, int nround)
{
    aes_encrypt_nround(&cipher[0], &message[0], expanded_key, nround);
}

void aesDecryptVector(vector<byte> &message, vector<byte> &cipher, byte* expanded_key, int nround)
{
    aes_decrypt_nround(&message[0], &cipher[0], expanded_key, nround);
}
